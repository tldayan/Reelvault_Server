...
const handleLogout = async(req,res) => {
    ...
    if(accessToken) {
        res.clearCookie("jwt_access", {httpOnly : true,domain: "vercel.com", secure: true, sameSite: "None"}) // Add 'secure: true' when in production
    }
    res.clearCookie("jwt_refresh", { httpOnly: true,domain: "vercel.com", secure: true, sameSite: "None"}); // Add 'secure: true' when in production
