...
const handleLogout = async(req,res) => {
    ...
    if(accessToken) {
        res.clearCookie("jwt_access", {httpOnly : true, secure: true}) // Add 'secure: true' when in production
    }
    res.clearCookie("jwt_refresh", { httpOnly: true, secure: true}); // Add 'secure: true' when in production
