...
const handleLogout = async(req,res) => {
    ...
    if(accessToken) {
        res.clearCookie("jwt_access", {secure: true, sameSite: "None"}) // Add 'secure: true' when in production
    }
    res.clearCookie("jwt_refresh", {secure: true, sameSite: "None"}); // Add 'secure: true' when in production
